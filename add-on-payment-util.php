	...
	*/
	...
	if( !function_exists('tourmaster_payment_method') ){
		function tourmaster_payment_method( $booking_detail = array() ){
			...
			if( $admin_approval && ($midtrans_enable || $paypal_enable || $credit_card_enable || $hipayprofessional_enable) ){
     ...
     */
	remove_action('wp_ajax_tourmaster_payment_template', 'tourmaster_ajax_payment_template');
    remove_action('wp_ajax_nopriv_tourmaster_payment_template', 'tourmaster_ajax_payment_template');

    /**
     * add the new function
     */
	add_action('wp_ajax_tourmaster_payment_template', 'NEW_MODIFIED_tourmaster_ajax_payment_template');
    add_action('wp_ajax_nopriv_tourmaster_payment_template', 'NEW_MODIFIED_tourmaster_ajax_payment_template');
    
	if( !function_exists('NEW_MODIFIED_tourmaster_ajax_payment_template') ){
		function NEW_MODIFIED_tourmaster_ajax_payment_template(){
		...
		} // NEW_MODIFIED_tourmaster_ajax_payment_template
	}
	...
	if( !function_exists('tourmaster_ajax_validate_coupon_code') ){
		...
		} // tourmaster_ajax_validate_coupon_code
	}
